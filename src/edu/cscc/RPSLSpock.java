...
public class RPSLSpock {
    ...
    /**
     * isValidPick validates human input
     *
     * @param pick value entered by player
     * @return boolean true if valid choice; false if invalid
     */
    ...
    /**
     * generatePick randomly assigns choice to the computer player
     *
     * @return computer pick of "rock", "paper", "sicssors", "lizard", or "spock"
     */
    ...
    /**
     * isComputerWin determines winner of the game
     *
     * @param c_pick computer's pick of rock, paper, scissors, lizard, or spock
     * @param h_pick human's pick of rock, paper, scissors, lizard, or spock
     * @return boolean true if computer wins; false if computer loses
     */
